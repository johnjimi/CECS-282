	...
	cout << "UpDate Testing - if no error message is displayed, The test is passed" << endl;
		...
		cout << endl << "Display D1 for -- testing, both dates must be the same" << endl;
			...
			if (D1 == D2) {}
				...
				cout << endl << "For this test, Julian date should be 2455497: " <<
				D1.getJulian() << endl; //print the Julian integer represented by D1


		int d1Int = D1.getJulian(), d3Int = D3.getJulian();
